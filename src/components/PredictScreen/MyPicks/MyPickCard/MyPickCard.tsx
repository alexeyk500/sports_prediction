...
import { getCompetitionBadge, getTeamBadge } from "../../MatchCardShared/match-card-presentation";
...
const MyPickCard: React.FC<IMyPickCardProps> = ({ prediction, fixture, onSelectOutcome }) => {
    ...
    <article className={styles.fixtureCard}>
      ...
      {fixture ? (
        <div className={styles.matchup}>
          <TeamIdentity badge={getTeamBadge(fixture.homeTeam)} name={fixture.homeTeam.name} />
          <span className={styles.versus}>VS</span>
          <TeamIdentity badge={getTeamBadge(fixture.awayTeam)} name={fixture.awayTeam.name} />
        </div>
      ) : null}
