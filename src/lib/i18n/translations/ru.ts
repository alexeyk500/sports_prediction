...
export const ru = {
  ...
  matches: {
    ...
    statusIntent: {
      SAVING: "Сохраняем...",
      DRAFT: "Скоро будет доступно",
      PREDICTIONS_CLOSED: "Приём прогнозов закрыт",
      LOCKED_AFTER_KICKOFF: "Закрыто после начала",
      LIVE: "Матч идёт",
      AWAITING_SETTLEMENT: "Ожидаем расчёт",
    ...
    reward: {
      ...
      start: "Смотреть рекламу",
      loading: "Загружаем рекламу",
      retry: "Попробовать ещё раз",
      status: {
        required: "Посмотрите рекламу, чтобы открыть этот прогноз.",
        preloading: "Готовим рекламу...",
        ready: "Реклама готова.",
        showing: "Реклама открыта.",
        confirming: "Подтверждаем награду...",
        failed: "Реклама недоступна. Попробуйте ещё раз.",
        rejected: "Награда не подтверждена. Попробуйте ещё раз.",
        timeout: "Реклама не загрузилась вовремя. Попробуйте ещё раз.",
      },
  ...
  errors: {
    ...
    AD_REWARD_NOT_ELIGIBLE: "Прогноз за рекламу сейчас недоступен.",
